...
export function AnalyticsIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
	return (
		<svg
			className={className}
			height="1rem"
...
export function SidebarLeftClose({ className, ...props }: SVGProps<SVGSVGElement>) {
	return (
		<svg
			className={className}
			height="1rem"
...
export function SidebarLeftOpen({ className, ...props }: SVGProps<SVGSVGElement>) {
	return (
		<svg
			className={className}
			height="1rem"
...
export function DoubleRingIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
	return (
		<svg
			className={className}
			height="1rem"
...
export function WarningCircleIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
	return (
		<svg
			className={className}
			height="1rem"
